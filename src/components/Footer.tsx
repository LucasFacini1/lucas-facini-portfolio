    ...
    <footer className="bg-dark-800/50 border-t border-neon-purple/20">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        >
          ...
          <p className="text-white/60 font-inter text-sm flex items-center">
            Feito com <Heart className="w-4 h-4 text-red-400 mx-1" /> e muito café
          </p>
        </motion.div>
      </div>
    </footer>
